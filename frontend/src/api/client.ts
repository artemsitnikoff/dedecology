...
export const client = api; // Alias для единообразия
...
// Дедупликация refresh: при «буре» одновременных 401 делаем ОДИН /auth/refresh,
// все ждут его. Иначе N конкурентных refresh → гонка и ложный logout, если хоть
// один из них транзиентно упадёт.
