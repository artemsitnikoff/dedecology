...
# 1-based номера столбцов «Фото 1..6» (для ширины колонок). Позиция в _HEADERS:
# … Кол-во фото(14) · Фото1(15) … Фото6(20) · …
_PHOTO_COLS = (15, 16, 17, 18, 19, 20)
...
def _row(inc: Incident, base_url: str, type_labels: dict | None) -> list:
    return [
        ...
        _photo_time(inc),
        inc.photos,
        # Столбцы «Фото 1..6» наполняются в build_xlsx (встраивание картинки +
