...
class Incident(Base, TimestampMixin):
    ...
    # ССЫЛКА на выбранное МНО (Mno.id). БЕЗ жёсткого FK (как region_code у Mno) —
    # свободная привязка. По ней считается живой счётчик обращений у МНО и фильтруется
    # список «инциденты этого МНО» (GET /incidents?mno_id=). NULL — МНО не выбрано.
