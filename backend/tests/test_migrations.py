...
incidents.mno_id + индекс ix_incidents_mno_id, вызывая upgrade/downgrade с
поддельным alembic.op (реальных запросов к БД нет).
"""
...
def test_migration_chain_single_head_is_0016():
    """Цепочка ревизий консистентна: ровно один head, и это 0016 (0016→0015→…)."""
