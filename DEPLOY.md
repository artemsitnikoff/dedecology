...
встраивает в .xlsx-выгрузку читая их с диска. **Нативную интеграцию с S3 в коде пока не успели
сделать** (в планах) — до неё рабочее решение без доработки кода — монтирование S3-бакета в путь
хранилища (§11.3), приложение при этом не меняется.
