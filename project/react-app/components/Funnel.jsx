...
function Funnel({ fStatuses, setFStatuses, incidents }) {
  ...
  return (
    <div className="de-scroll" style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '11px 28px', borderBottom: '1px solid #E6E9EC', background: '#F8F9FB', flex: 'none', overflowX: 'auto' }}>
