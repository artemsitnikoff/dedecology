...
(`Mno.created_at`, TimestampMixin, фиксируется на вставке; в MnoListItem.created_at), кнопки ФГИС-синка/
ручного добавления скрыты. **Фото обращения — до 6** (было 3): intake `_MAX_PHOTOS=6`, форма, maxbot
