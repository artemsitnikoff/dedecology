...
- **.xlsx-выгрузка** — 17 колонок: Заявитель · Источник · Статус · Регион · Город/н.п. · Адрес(улица) ·
  ...
  формула `=_xlfn.IMAGE("<полный URL>","Фото N")` (Excel 365/Online рисует картинку по URL в ячейке;
  `_xlfn.` обязателен; в Excel 2019/2021 и МойОфис/Р7 → #ИМЯ?). Строки с фото выше (height≈80), столбцы Фото шире.
